...
import {
  ...
  searchMovie,
  sortMovie,
} from "../../../services/adminServices/movieServices";
    ...
    <>
      ...
      {showAddForm && (
        <Modal
          ...
          open={handleShowAddForm}
          cancelText="Hủy"
          title="Thêm phim mới"
          centered={true}
        >
          <FormAddMovie closeForm={handleCloseAddForm} />
        </Modal>
      )}
            ...
            {pageableData?.content?.map((movie) => {
              return (
                <tr key={movie.id}>
                  ...
                  <td className="border border-black">
                    <Button danger onClick={() => handleDeleteMovie(movie.id)}>
                      Xóa phim
                    </Button>
                  </td>
                </tr>
